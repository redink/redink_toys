...
%% Port = 19000
%% SocketOpts = [inet6] ++ []
%% OnStartup = {rabbit_net_app, tcp_listener_started, [amqp]}
%% OnShutdown = {rabbit_net_app, tcp_listener_stopped, [amqp]}
%% AcceptCallback = {rabbit_net_app, start_client, []}
%% Label = "TCP Listener"
...
init({IPAddress, Port, SocketOpts, OnStartup, OnShutdown,
    ...
    %% tcp_acceptor_sup.
    Name = rabbit_net_app:tcp_name(tcp_acceptor_sup, IPAddress, Port),
